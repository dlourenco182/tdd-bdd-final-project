...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_a_product(self):
        ...
        self.assertEqual(original_id.id, product.id)
    ...
    def test_find_by_name(self):
        ...
        for product in products:
            if len(product.name) == first_product_name:
                count = count + 1
    ...
    def test_find_by_availability(self):
        ...
        for _ in range(10):
            product = ProductFactory()
            product.create()
        first_product_availability = products[0].availability
        count = 0
        for product in products:
            if len(product.availability) == first_product_availability:
                count = count + 1
    ...
    def test_find_by_category(self):
        ...
        count = 0
        for product in products:
            if len(product.category) == first_product_category:
                count = count + 1
